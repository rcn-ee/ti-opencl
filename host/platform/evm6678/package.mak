...
override PKGDIR = platform/evm6678
...
package/%.xdc.inc package/%_platform.evm6678.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package platform.evm6678" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js platform.evm6678 $@
...
.PHONY: release,platform_evm6678
platform_evm6678.zip: package/package.bld.xml
platform_evm6678.zip: package/package.ext.xml
platform_evm6678.zip: package/package.rel.dot
platform_evm6678.zip: package/build.cfg
platform_evm6678.zip: package/package.xdc.inc
platform_evm6678.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/platform_evm6678.zip.dep
endif
package/rel/platform_evm6678/platform/evm6678/package/package.rel.xml:

platform_evm6678.zip: package/rel/platform_evm6678.xdc.inc package/rel/platform_evm6678/platform/evm6678/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/platform_evm6678.xdc.inc,package/rel/platform_evm6678.zip.dep)


release release,platform_evm6678: all platform_evm6678.zip
clean:: .clean
	-$(RM) platform_evm6678.zip
	-$(RM) package/rel/platform_evm6678.xdc.inc
	-$(RM) package/rel/platform_evm6678.zip.dep
