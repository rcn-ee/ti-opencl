...
OSAL_con_var_record_t OSAL_con_var_table       [OSAL_MAX_CVS];
...
uint32          TI_OSAL_printf_enabled = TRUE;
                      ...
                      uint32 flags)
{
    ...
    os_priority = TI_OSAL_PriorityRemap(priority);
   ...
   */
    ...
    */
    ...
    OSAL_task_table[possible_taskid].creator = TI_OSAL_FindCreator();
    ...
    */
    ...
    else
    {
       ...
       *mut_id = possible_mutid;
       ...
       OSAL_mut_sem_table[*mut_id].creator = TI_OSAL_FindCreator();
...
int32 TI_OSAL_ConVarCreate (uint32 *cv_id, const char *cv_name, uint32 options)
{
    ...
    for (i = 0; i < OSAL_MAX_CVS; i++)
    {
        if ((OSAL_con_var_table[i].free == FALSE) &&
                strcmp ((char*) cv_name, OSAL_con_var_table[i].name) == 0)
        {
            pthread_mutex_unlock(&OSAL_con_var_table_mut);
            return OSAL_ERR_NAME_TAKEN;
        }
	...
	*/
    ...
    else
    {
       ...
       *cv_id = possible_cvid;
       ...
       OSAL_con_var_table[*cv_id].creator = TI_OSAL_FindCreator();
...
/*---------------------------------------------------------------------------------------
    ...
    Purpose: This function signal a conditional variable
...
/*---------------------------------------------------------------------------------------
    ...
    Purpose: This function bradcasts a conditional variable
...
/*---------------------------------------------------------------------------------------
    ...
    Purpose: This function waits on a specified conditional variable
...
void TI_OSAL_printf( const char *String, ...)
{
    ...
    if ( TI_OSAL_printf_enabled == TRUE )
    {
       va_start(ptr,String);
...
---------------------------------------------------------------------------------------*/
int32 TI_OSAL_GetErrorName(int32 error_num, osal_err_name_t * err_name)
{
